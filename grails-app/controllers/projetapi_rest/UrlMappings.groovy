...
class UrlMappings {
    ...
    static mappings = {
        ...
        "/library/$libraryID/book/$id"(controller:'RequestManager',action:'updateBookByLibrary',method:'PUT')
        "/library/$libraryID/book/$id"(controller:'RequestManager',action:'deleteBookByLibrary',method:'DELETE')
        "/library/$libraryID/book"(controller:'RequestManager',action:'createBookByLibrary',method:'POST')
